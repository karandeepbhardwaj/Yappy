...
- ffmpeg (optional, improves audio conversion quality)

## Quick Start

```bash
git clone https://github.com/your-username/sunyapper.git
cd sunyapper
npm install
npm run compile
```
...
- **Audio capture**: WebView with Web Audio API — no native mic dependencies
